export const WORK_ITEM_TYPES = { module: "MODULE", story: "STORY", task: "TASK", bug: "BUG", subTask: "SUB_TASK" } as const;
...
export const MEMBER_ROLES = { owner: "OWNER", admin: "ADMIN", projectLead: "PROJECT_LEAD", member: "MEMBER", viewer: "VIEWER" } as const;
...
export const GITHUB_INSTALLATION_ACTIONS = { created: "created", deleted: "deleted", suspend: "suspend", unsuspend: "unsuspend", newPermissionsAccepted: "new_permissions_accepted" } as const;
export type GithubInstallationAction = (typeof GITHUB_INSTALLATION_ACTIONS)[keyof typeof GITHUB_INSTALLATION_ACTIONS];
export const GITHUB_PULL_REQUEST_ACTIONS = { opened: "opened", reopened: "reopened", closed: "closed", synchronize: "synchronize" } as const;
export type GithubPullRequestAction = (typeof GITHUB_PULL_REQUEST_ACTIONS)[keyof typeof GITHUB_PULL_REQUEST_ACTIONS];
export const INTEGRATION_TYPES = { github: "GITHUB", discord: "DISCORD", googleDrive: "GOOGLE_DRIVE" } as const;
export type IntegrationType = (typeof INTEGRATION_TYPES)[keyof typeof INTEGRATION_TYPES];
export const INTEGRATION_STATES = { connected: "CONNECTED", disconnected: "DISCONNECTED", degraded: "DEGRADED" } as const;
export type IntegrationState = (typeof INTEGRATION_STATES)[keyof typeof INTEGRATION_STATES];
export const AUTOMATION_TRIGGERS = { workItemCreated: "WORK_ITEM_CREATED", workItemTransitioned: "WORK_ITEM_TRANSITIONED", sprintStarted: "SPRINT_STARTED", sprintCompleted: "SPRINT_COMPLETED", pullRequestOpened: "PULL_REQUEST_OPENED", pullRequestMerged: "PULL_REQUEST_MERGED", scheduled: "SCHEDULED" } as const;
export type AutomationTrigger = (typeof AUTOMATION_TRIGGERS)[keyof typeof AUTOMATION_TRIGGERS];
export const AUTOMATION_ACTIONS = { transitionWorkItem: "TRANSITION_WORK_ITEM", assignMember: "ASSIGN_MEMBER", addLabel: "ADD_LABEL", notifyDiscord: "NOTIFY_DISCORD", createGithubIssue: "CREATE_GITHUB_ISSUE" } as const;
...
export const DOCUMENT_TYPES = { folder: "FOLDER", file: "FILE", googleDoc: "GOOGLE_DOC", googleSheet: "GOOGLE_SHEET", googleSlide: "GOOGLE_SLIDE" } as const;
export type DocumentType = (typeof DOCUMENT_TYPES)[keyof typeof DOCUMENT_TYPES];
export const PROBLEM_CODES = { validationFailed: "VALIDATION_FAILED", notFound: "NOT_FOUND", conflict: "CONFLICT", unauthorized: "UNAUTHORIZED", forbidden: "FORBIDDEN", integrationUnavailable: "INTEGRATION_UNAVAILABLE", internalError: "INTERNAL_ERROR" } as const;
export type ProblemCode = (typeof PROBLEM_CODES)[keyof typeof PROBLEM_CODES];
export const REQUIRED_ACTIONS = { none: "NONE", signIn: "SIGN_IN", requestAccess: "REQUEST_ACCESS", reconnectIntegration: "RECONNECT_INTEGRATION", retry: "RETRY", fixInput: "FIX_INPUT" } as const;
export type RequiredAction = (typeof REQUIRED_ACTIONS)[keyof typeof REQUIRED_ACTIONS];
export interface ApiProblem { type: string; status: number; code: ProblemCode; titleKey: string; detailKey: string; requiredAction: RequiredAction; correlationId: string; meta: Record<string, unknown>; }
