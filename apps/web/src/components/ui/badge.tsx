  ...
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-md border px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-colors [&>svg]:size-3 [&>svg]:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-transparent bg-warning/20 text-amber-800 dark:text-amber-300",
        info: "border-transparent bg-info/15 text-blue-700 dark:text-blue-300",
        purple:
          "border-transparent bg-primary/15 text-primary dark:text-violet-300",
      },
    },
