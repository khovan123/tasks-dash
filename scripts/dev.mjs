...
execSync("npm run build -w @tasks-dash/contracts && npm run build -w @tasks-dash/api", { stdio: "inherit" });

const children = [
  spawn("npm", ["run", "dev", "-w", "@tasks-dash/contracts"], { stdio: "inherit", shell: true }),
